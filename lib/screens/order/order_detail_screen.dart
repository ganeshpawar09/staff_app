...
//     final dataOrderItem = data[index];
//     return Container(
//       child: Column(
//         children: <Widget>[
//           Padding(
...
//               Text(('Part Id: ${dataOrderItem.document.partId}'),
...
//             padding: const EdgeInsets.only(top: 0, bottom: 0),
//             child: Row(children: <Widget>[
//               Text(('Part Name: ${dataOrderItem.document.description}'),
//                   style: AppStyles.mondaB.copyWith(fontSize: 12)),
//             ]),
//           ),
//           Padding(
//             padding: const EdgeInsets.only(top: 0, bottom: 0),
//             child: Row(children: <Widget>[
//               Text(('Vendor:'), style: AppStyles.mondaB.copyWith(fontSize: 12)),
//             ]),
//           ),
//           Padding(
//             padding: const EdgeInsets.only(top: 0, bottom: 0),
